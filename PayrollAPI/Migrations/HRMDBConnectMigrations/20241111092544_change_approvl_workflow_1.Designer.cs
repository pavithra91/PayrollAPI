...
namespace PayrollAPI.Migrations.HRMDBConnectMigrations
{
    ...
    [Migration("20241111092544_change_approvl_workflow_1")]
    partial class change_approvl_workflow_1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PayrollAPI.Models.HRM.EmpApprovalWorkflow", b =>
                {
                    ...
                    b.Property<int>("empApprovalWorkflowid")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("empApprovalWorkflowid");
            ...
            modelBuilder.Entity("PayrollAPI.Models.HRM.EmpApprovalWorkflow", b =>
                {
                    ...
                    b.HasOne("PayrollAPI.Models.HRM.EmpApprovalWorkflow", "empApprovalWorkflow")
                        .WithMany()
                        .HasForeignKey("empApprovalWorkflowid")
                    ...
                    b.Navigation("empApprovalWorkflow");
                });

            modelBuilder.Entity("PayrollAPI.Models.HRM.EmpApprovals", b =>
                {
                    b.HasOne("PayrollAPI.Models.HRM.EmpApprovals", null)
                        .WithMany("empApprovals")
                        .HasForeignKey("EmpApprovalsid");
                });
