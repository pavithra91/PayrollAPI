...
namespace PayrollAPI.Migrations.HRMDBConnectMigrations
{
    ...
    [Migration("20250103162304_createReservationPaymentView")]
    partial class createReservationPaymentView
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PayrollAPI.Models.Reservation.CancellationCharges", b =>
                {
                    ...
                    b.Property<int>("cancellation_Policy")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PayrollAPI.Models.Reservation.Reservation_Payments_View", b =>
                {
                    ...
                    b.ToTable("GetReservationPaymentDetails");
                });
            ...
            modelBuilder.Entity("PayrollAPI.Models.Reservation.CancellationCharges", b =>
                {
                    b.HasOne("PayrollAPI.Models.Reservation.Bungalow_Reservation", "reservation")
                        .WithOne("cancellationCharges")
                        .HasForeignKey("PayrollAPI.Models.Reservation.CancellationCharges", "reservationID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
